...
/* harmony import */ var _modules_clearValue__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./modules/clearValue */ "./src/js/modules/clearValue.js");
/* harmony import */ var _modules_filters__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./modules/filters */ "./src/js/modules/filters.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_clearValue__WEBPACK_IMPORTED_MODULE_7__["default"])(modalState);
  Object(_modules_filters__WEBPACK_IMPORTED_MODULE_8__["default"])();
...
var accordion = function accordion(targetSelector, itemsSelector) {
  var btns = document.querySelectorAll(targetSelector),
  ...
  btns.forEach(function (btn) {
    btn.addEventListener('click', function () {
      ...
      blocks.forEach(function (block) {
        if (_this.nextElementSibling.classList.contains('active-content')) return;
        block.classList.remove('active-content');
        block.style.maxHeight = '0px';
      });
      btns.forEach(function (btn) {
        if (_this.classList.contains('active-style')) return;
...
"use strict";
__webpack_require__.r(__webpack_exports__);
var burger = function burger(menu, selector) {
  ...
  burgerSelector.addEventListener('click', function () {
    if (burgerMenu.style.display =  true && window.screen.availWidth < 993) {
...
var calc = function calc(size, material, options, promocode, result, state) {
  ...
  var calcPictures = function calcPictures() {
...
var clearValue = function clearValue(state) {
...
/* harmony default export */ __webpack_exports__["default"] = (clearValue);
...
var filters = function filters() {
  ...
  function clickBtn(btn, markType) {
    btn.addEventListener('click', function () {
      typeFilter(markType);
    });
  }
...
/* harmony import */ var _clearValue__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./clearValue */ "./src/js/modules/clearValue.js");
/* harmony import */ var _calc__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./calc */ "./src/js/modules/calc.js");
  ...
  form.forEach(function (item) {
    item.addEventListener('submit', function (e) {
      ...
      Object(_services_requests__WEBPACK_IMPORTED_MODULE_6__["postData"])(api, formData).then(function (res) {
        ...
        clearInputs();
        Object(_clearValue__WEBPACK_IMPORTED_MODULE_7__["default"])(state);
        document.querySelectorAll(".calc-select").forEach(function (select) {
          select.value = "";
        });
